                        ...
                        <table class="table" id="variations">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="table-text"><?php if(isset($c->event->away->school)){ echo $c->event->away->school; } ?> at <?php if(isset($c->event->home->school)){ echo $c->event->home->school; } ?>| <?php if(isset($c->variation->name)) { echo $c->variation->name; }  ?> | <a href="{{$c->shorts}}"> {{$c->shorts}}</a> --> <a href="{{$c->longs}}">{{App\Helper\CampaignHelper::shorten($c->longs, 40)}} </a></td>
